...
> Source material for the copied setup workflow. Paraphrase this intent into a draft in your automation platform's reviewed creation flow after you confirm that the copied pack is committed in the repository where the automation will run.
