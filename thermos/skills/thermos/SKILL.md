...
3. Launch both subagents at once, in the background:
   - the `thermo-nuclear-review-subagent` agent for bugs, breakages, security, devex regressions, feature-flag leaks, and other branch-audit risks.
   - the `thermo-nuclear-code-quality-review-subagent` agent for maintainability, structure, file-size growth, spaghetti, abstractions, and codebase-health risks.
